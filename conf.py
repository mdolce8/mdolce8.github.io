...
BLOG_AUTHOR = "Michael Dolce"  # (translatable)
BLOG_TITLE = "Michael Dolce"  # (translatable)
...
BLOG_EMAIL = "mike.dolce8@gmail.com"
BLOG_DESCRIPTION = "Michael Dolce's personal webpage"  # (translatable)
...
# I believe the path stub preceding the "/" is "output"......
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
...
FAVICONS = (
    ("icon", "/images/triangle-circle-square-transparent.png", "152x152"),
    ("icon", "/images/triangle-circle-square-transparent.png", "16x16"),
)
